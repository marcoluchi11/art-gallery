  ...
  return (
    <article className="mt-20">
      <p className="font-thin">
        ...
        Martha&apos;s Vineyard. Born and raised in Eastern Europe. Moved to the
        USA right after he graduated in Architecture and Design. Between all
        this time he has practiced abstract painting and fashion design and
        constantly creating pieces that are a mark of his artistic life.
      </p>

      <p className="font-thin mt-5">
        Speaking of that, some of the main sources of his inspiration to make
        art but not only that followed the artist throughout 15 years are COLOR,
        SHAPES, SILUETES, STRUCTURE, TEXTURE, DEPTH, CAOS, SIMPLICITY. A journey
        that will follow you through the entire observation of his art pieces.
        Albion is an artist who his professional creative career has taken him
        from fashion design to abstract painting to sketching to interior design
      ...
      <p className="font-thin mt-5">
        ...
        resurgences ready to hide or be dissolved. He is inspired by the humans,
        the silhouettes, the crowds, the look, the face, the shadow, the light,
        the depth of a conversation. In this way, he approaches the relationship
        of the individual to the world, the fragile human condition. He likes
        the freedom of the line, of shape, it is an intuitive painting, a fight
        between chaos and order, between simple and complex. Large scale is his
        specialty, but he has collected numerous pieces on the smaller scale as
        well
      </p>
      ...
      <p className="font-thin mt-5">
        ...
        shape. When these two elements converge, the possibilities for creating
        art become boundless. For me personally, however, painting transcends
        the mere combination of color and shape. It is a process that begins
        with an emotion or feeling, which then spills out onto the canvas. I
        connect with different cultures, different people and give them a piece
        of me from who they are as a reflection of admiration for something
      ...
      <p className="font-thin mt-5">
        ...
        fleeting moments and freeze them in time on the canvas, inviting others
        to share in the experience.
      </p>
      <p className="font-thin mt-5 mb-5">
        Painting allows me to communicate beyond words, to communicate in the
        language of colors, shapes, and emotions. It is a profound and intimate
        means of expression, enabling me to convey the depth of my perception
        and invite others to join me on this artistic journey. It’s a form of
        meditation for me and it has been so for over +15 years now. It simply
        takes over me. “It takes me to start painting so I can stop everything
        around me move.”
      </p>
    </article>
  );
